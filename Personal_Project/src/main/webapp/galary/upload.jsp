	...
	<section id="galaryWrite">
		<form action="uploadPro.jsp" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					<th>writer</th>
					<td><input type="text" name="galName" value="<%=mb.getName()%>" readonly id="name"></td>
				</tr>
				<tr>
					<th>title</th>
				...
				<tr>
					<th>file</th>
					<td><input type="file" name="galFile" accept=".jpg,.png,.gif"></td>
				</tr>

			</table>
			<div id="button">
				<input type="button" value="cancel" class="btn" onclick="location.href='galaryList.jsp'">
